...
from aisi_joints.constants import CLASS_DEFECT
from aisi_joints.constants import CLASS_OK
...
class MetricsWidget(Ui_MetricsWidget, QWidget):
    ...
    def show_metrics(self, df: pd.DataFrame):
        report = classification_report(df["cls"], df["detected_class"], digits=4)
