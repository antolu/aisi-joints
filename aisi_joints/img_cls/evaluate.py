"""This module provides everything needed to evaluate a trained model, either a
checkpoint + config, or exported model (with or without temperature scaling).
...
from .._utils import time_execution
...
def main(argv: Optional[List[str]] = None):
    ...
    if args.config is None:
        ...
        checkpoint_path = get_latest(args.model_dir, lambda o: o.endswith(".h5"))
