"""Script to remove rows of a dataset .csv based on eventIds, where the
eventIds to remove are in a second .csv.
...
def filter_dataframe(
    ...
    for i, filter in enumerate(filters):
        ...
        df = df[
            ~df[["eventId"]].apply(tuple, 1).isin(filter[["eventId"]].apply(tuple, 1))
        ]
