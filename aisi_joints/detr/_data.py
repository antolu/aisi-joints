...
class CocoDetection(torchvision.datasets.CocoDetection):
    def __init__(self, dataset_folder: str, split_name: str, feature_extractor):
        ann_file = os.path.join(dataset_folder, "annotations", f"{split_name}.json")
...
def results_to_coco(
    coco_gt: COCO, results: list, labelmap: Dict[int, str] = None
) -> dict:
    if labelmap is None:
        labelmap = LABEL_MAP
