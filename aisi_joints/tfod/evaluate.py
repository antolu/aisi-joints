"""This script serves as a helper to evaluate an exported tensorflow object
detection model on a custom formatted dataset (used in this package).
...
from object_detection.metrics.coco_tools import COCOEvalWrapper
